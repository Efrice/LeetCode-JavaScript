import{_ as s,c as n,o as a,d as l}from"./app.7e8fbadb.js";const i=JSON.parse('{"title":"226. 翻转二叉树","description":"","frontmatter":{},"headers":[],"relativePath":"problems/226.翻转二叉树.md"}'),p={name:"problems/226.翻转二叉树.md"},o=l(`<h1 id="_226-翻转二叉树" tabindex="-1">226. 翻转二叉树 <a class="header-anchor" href="#_226-翻转二叉树" aria-hidden="true">#</a></h1><p>给你一棵二叉树的根节点 root ，翻转这棵二叉树，并返回其根节点。</p><p>示例 1：</p><pre><code>   4
  / \\
 2   7
/ \\ / \\
1 3 6 9
...
/ \\
1 3
</code></pre><p>输入：root = [2,1,3]<br> 输出：[2,3,1]</p><p>示例 3：<br> 输入：root = []<br> 输出：[]</p><p>提示：<br> 树中节点数目范围在 [0, 100] 内<br> -100 &lt;= Node.val &lt;= 100</p><p>来源：力扣（LeetCode）<br> 链接：<a href="https://leetcode.cn/problems/invert-binary-tree" target="_blank" rel="noreferrer">https://leetcode.cn/problems/invert-binary-tree</a></p><div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki"><code><span class="line"><span style="color:#676E95;">/**</span></span>
